...
Using [openFrameworks](https://openframeworks.cc) with additional plugins [ofxMidi](https://github.com/danomatika/ofxMidi), [ofxDatGui](https://braitsch.github.io/ofxDatGui/index.html) and [ofxSpout](https://github.com/elliotwoods/ofxSpout).
