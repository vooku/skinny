...
struct LayerDescription : public MappableDescription
{
  ...
  LayerDescription(unsigned int id, const std::filesystem::path& path, midiNote note = invalid_midi, midiNote cc = invalid_midi, int alpha = MAX_7BIT, const BlendMode& blendMode = DEFAULT_BLEND_MODE);
